...
$settore_taxmeta->addParagraph('aree_settori_paragraph1',array('value'=> __('<font style="color:red;">I campi qui di seguito sono utili solo per ampliare le funzionalità del sito (tabella e viste varie) e NON saranno inclusi nel dataset xml</font>')));
